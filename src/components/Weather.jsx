        ...
        <div className="weather__info">
            <p className="weather__key">
                {props.weather.weather && (
                    <span className="weather__value">{props.weather.weather} </span>
                )}
            ...
            {props.weather.sunrise && (
                <p className="weather__key">
                    <b>Восход солнца в</b>{' '}
                    <span className="weather__value">{props.weather.sunrise}</span>
                </p>
            )}
            {props.weather.sunset && (
                <p className="weather__key">
                    <b>Закат солнца в</b>{' '}
                    <span className="weather__value">{props.weather.sunset}</span>
                </p>
            )}
